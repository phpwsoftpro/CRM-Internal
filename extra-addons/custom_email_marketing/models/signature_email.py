...
class MailComposer(models.TransientModel):
    ...
    def _get_user_signature(self, user):
        """Generate unified HTML signature"""
        profile_picture = (
            "https://aptech.vn/wp-content/uploads/2018/12/logo-wsoftpro.jpg"
        )

        # Include modern icons (SVG directly in HTML)
        signature_html = f"""
<table style="display: inline-block; text-align: left;">
    <tr>
        <td style="padding-right: 15px; vertical-align: top;">
            <img src="{profile_picture}" alt="Profile" style="width: 120px; height: 120px; border-radius: 5px; object-fit: cover;">
            </td>
                    ...
                    <br>
                        ...
                        <hr style="border: none; border-top: 1px solid #ddd; margin: 10px 0;">
                            <div style="margin-bottom: 4px;">
                                ...
                                <span style="color: #666666; font-size: 13px;">{user.phone or ''}</span>
                            </div>
                            <div style="margin-bottom: 4px;">
                                <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" viewBox="0 0 16 16" style="color: #666666;">
